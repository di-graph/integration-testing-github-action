...
function getDownloadObject() {
    ...
    return {url: "https://github.com/di-graph/integration-testing-cli/archive/refs/tags/v0.4.tar.gz", binaryName: binaryName}
  }
...
async function setup() {
    try {
        ...
        pathToCLI = path.join(pathToCLI, 'integration-testing-cli-0.4');
